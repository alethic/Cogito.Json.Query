...
Cogito.Json.Query — Provides a simple query language across a JSON-compatible object model. Includes a compiler for compiling this query language to Expressions.

Publishes 1 package: `Cogito.Json.Query`.
